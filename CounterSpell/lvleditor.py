...
blob_img = pygame.image.load('img/spike_img.png')
platform_x_img = pygame.image.load('img/dirt_img.png')
platform_y_img = pygame.image.load('img/dirt_img.png')
lava_img = pygame.image.load('img/spike_img.png')
coin_img = pygame.image.load('img/coin.png')
exit_img = pygame.image.load('img/sun_img.png')
save_img = pygame.image.load('img/coin.png')
load_img = pygame.image.load('img/spike_img.png')
